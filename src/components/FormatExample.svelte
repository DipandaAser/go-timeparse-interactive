...
>
  <div>
    <div>
      <span class="font-medium text-gray-200 mr-2">Layout: </span>
      <span class="font-medium font-mono text-gray-400 tracking-tighter"
        >{layout}
      </span>
    </div>
    <div>
      <span class="font-medium text-gray-200 mr-2">Current: </span>
